...
yohane_deepblue__location = {}
yohane_deepblue__location.__index = yohane_deepblue__location
...
function yohane_deepblue__location.new(name)
    local self = setmetatable({}, yohane_deepblue__location)
    if name then
...
function yohane_deepblue__location:connect_one_way(exit, rule)
    if type(exit) == "string" then
        ...
        if existing then
            ...
            exit = yohane_deepblue__location.new(exit)
        end
    end
    if rule == nil then
        rule = always
...
function yohane_deepblue__location:connect_two_ways(exit, rule)
...
function yohane_deepblue__location:connect_one_way_entrance(name, exit, rule)
    if rule == nil then
        rule = always
    end
    self.exits[#self.exits + 1] = { exit, rule }
...
function yohane_deepblue__location:connect_two_ways_entrance(name, exit, rule)
...
-- acts as a shortcut for 2 connect_one_way_entrance-calls
function yohane_deepblue__location:connect_two_ways_entrance_door_stuck(name, exit, rule1, rule2)
...
function yohane_deepblue__location:connect_two_ways_stuck(exit, rule1, rule2)
...
function yohane_deepblue__location:accessibility()
...
-- 
function yohane_deepblue__location:discover(accessibility, keys)
...
entry_point = yohane_deepblue__location.new("entry_point")
